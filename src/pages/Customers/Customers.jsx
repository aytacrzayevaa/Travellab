...
import Filterbtn from "../../assets/customers/Filterbtn.svg";
import Newcustomers from "../../assets/customers/NewCustomer.svg";
import Eyebtn from "../../assets/customers/Eyebtn.svg";
import { useNavbar } from "../../contexts/NavbarContext";
import Modal from "../../components/FilterModal"; // Modal'ı içe aktar
  ...
  return (
    <div
      className={`customers-container ${
        isNavbarCollapsed ? "customers-container--navbar-closed" : ""
      }`}
    >
      <div className="customers-header">
        <p>
          Əsas səhifə / <span> Müştərilər</span>
        </p>

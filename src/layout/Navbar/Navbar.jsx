...
const Navbar = () => {
      ...
      <div className="qrmodal">
        <div className="qrmodal__content">
          <div className="qrmodal__header">
            <button className="qrmodal__close" onClick={onClose}><img src={Closebtn} alt="" /></button>
            <p>QR Code</p>
          </div>
          <div className="qrmodal__body">
            <img src={QRdemo} alt="" />
            <h4>Skan et</h4>
            <p>Skan etdikdən sonra, sizin “WhatsApp” konktaktlarınız əlavə olacaqdır</p>
            <button className="qrmodal__close-button" onClick={onClose}>Bağla</button>
          </div>
        </div>
      </div>,
      document.body
      ...
      <div className="ctmodal">
        <div className="ctmodal__content">
          <div className="ctmodal__header">
            <button className="ctmodal__close" onClick={onClose}><img src={Closebtn} alt="Close" /></button>
            <p>Kalkulyator</p>
          </div>
  ...
  <div className="input-group">
    ...
    <input type="number" id="qiymet" name="qiymet" placeholder="Məbləğ" />
  </div>

  {/* Second input for "ay" (select with options) */}
  <div className="input-group">
  ...
  {/* Third input for "taksit karti" (select with options) */}
  <div className="input-group">
    <label htmlFor="taksitKarti">Taksit Kartı</label>
    <select id="taksitKarti" name="taksitKarti">
      ...
      <option value="yelokart">YeloKart</option>
            ...
            <button className="ctmodal__close-button" onClick={onClose}>Kapat</button>
    ...
    <div className={`navbar ${isNavbarCollapsed ? 'navbar--closed' : 'navbar--open'}`}>
      ...
      <div className="navbar__data">
        ...
        <div className="navbar__data__right">
          <img src={Calculator} alt="Calculator" onClick={openCalculatorModal} />
      ...
      <CalculatorModal isOpen={isCalculatorModalOpen} onClose={closeCalculatorModal} />
    </div>
  );
};
